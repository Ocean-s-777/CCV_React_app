...
export default class Home extends Component {
  render() {
    return (
      ...
      <h3>You can continue your journey here by <a href="?">viewing our 'about us'-page</a> or moving onto the graphs by clicking a link in the top bar. You can also move to view the user-specific graphs linked to this user.</h3>
      </>
    )
  }
}
